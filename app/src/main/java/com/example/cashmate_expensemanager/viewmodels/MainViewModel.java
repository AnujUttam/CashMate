package com.example.cashmate_expensemanager.viewmodels;
...
public class MainViewModel extends AndroidViewModel {
    ...
    public void addTransactions(){
        realm.beginTransaction();
        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Business","Cash","Some Note",new Date(),500,new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE,"Rent","other","Some Note",new Date(),-500,new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Salary","PayTm","Some Note",new Date(),500,new Date().getTime()));
        realm.copyToRealmOrUpdate(new Transaction(Constants.EXPENSE,"Other","Cash","Some Note",new Date(),-500,new Date().getTime()));
